...
- Generates text faster than gpt-2-simple and with better memory efficiency! (even [from the 1.5B GPT-2 model](https://docs.aitextgen.io/tutorials/generate_1_5b/)!) You can also export and generate from your model with ONNX/ONNX Runtime (for [much faster performance](https://medium.com/microsoftazure/faster-and-smaller-quantized-nlp-with-hugging-face-and-onnx-runtime-ec5525473bb7)) or CoreML (for iOS or using a GPU on macOS).
